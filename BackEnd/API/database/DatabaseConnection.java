...
public class DatabaseConnection {
  ...
  * <pre>{@code
    ...
    */
     ...
     * @see security.PasswordTools#hashPassword(String)
    */
    public static ResultSet createEmployee(String email, String passwordHash, String name, int businessID) throws ClassNotFoundException, SQLException
    {
      return executeStoredProcedure("CreateEmployee", email, passwordHash, name, String.valueOf(businessID));
    }
