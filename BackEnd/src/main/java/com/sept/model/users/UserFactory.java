...
import com.sept.exceptions.PasswordTooWeakException;
import com.sept.model.database.DatabaseConnection;
import com.sept.model.security.PasswordTools;
  ...
  */
  public Business[] loadBusinesses()
  {
    ...
    try {
      ...
      throw new RuntimeException("SQL code returned an errant value for loading businesses");
    }
